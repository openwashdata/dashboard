...
```{r, include=FALSE}
# Load data
load("/Users/ydubey/Desktop/plausible_pkg/plausible/data/ds4owd/timeseries.rda")
load("/Users/ydubey/Desktop/plausible_pkg/plausible/data/ds4owd/country.rda")
load("/Users/ydubey/Desktop/plausible_pkg/plausible/data/ds4owd/source.rda")
stats <- read_csv("/Users/ydubey/Desktop/plausible_pkg/plausible/data/dashboard/website_stats.csv")
# Move timeseries data to this folder for access in OJS
write.csv(ds4owd_timeseries, "ds4owd_timeseries.csv", row.names = FALSE)
```
...
```{r}
# Load data
load("/Users/ydubey/Desktop/post_survey_pkg/postsurvey/data/postsurvey.rda")
load("/Users/ydubey/Desktop/reg_data_pkg/regdata/data/presurvey.rda")
load("/Users/ydubey/Desktop/reg_data_pkg/regdata/data/locations.rda")
```
...
```{r}
load("/Users/ydubey/Desktop/Posit package/positcloud/data/positcloud.rda")
```
